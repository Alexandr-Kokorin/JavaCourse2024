...
public class Chat extends TableImpl<ChatRecord> {
    ...
    /**
     * The column <code>CHAT.NAME</code>.
     */
    public final TableField<ChatRecord, String> NAME = createField(DSL.name("NAME"), SQLDataType.VARCHAR(1000000000).nullable(false), this, "");

    /**
     * The column <code>CHAT.STATE</code>.
     */
    public final TableField<ChatRecord, String> STATE = createField(DSL.name("STATE"), SQLDataType.VARCHAR(1000000000).nullable(false), this, "");
